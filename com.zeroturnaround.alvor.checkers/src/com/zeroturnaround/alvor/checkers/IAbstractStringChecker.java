...
public interface IAbstractStringChecker {
	...
	Collection<HotspotCheckingResult> checkAbstractStrings(List<StringNodeDescriptor> descriptors, ProjectConfiguration configuration) throws CheckerException;
