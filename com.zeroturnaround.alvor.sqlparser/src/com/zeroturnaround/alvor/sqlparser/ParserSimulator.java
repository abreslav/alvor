...
import com.zeroturnaround.alvor.sqlparser.framework.IError;
import com.zeroturnaround.alvor.sqlparser.framework.LRParser;
import com.zeroturnaround.alvor.sqlparser.framework.NaiveAbstractInterpreter;
import com.zeroturnaround.alvor.sqlparser.framework.ShortestCounterExampleAbstractInterpreter;
...
//		fixpointParser.parse(transduction);
	...
	public boolean parseAutomaton(State initial, IAlphabetConverter alphabetConverter) {
		com.zeroturnaround.alvor.sqlparser.framework.LRParser<S> lrParser = new com.zeroturnaround.alvor.sqlparser.framework.LRParser<S>(parser, stackFactory, alphabetConverter);
